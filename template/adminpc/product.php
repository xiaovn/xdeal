...
﻿			<h1 class="grid_12">Quản lý sản phẩm</h1>
			...
			<div class="grid_12">
				<div class="box">
					...
					<div class="tabletools">
							<div class="left">
								<a class="open-add-client-dialog" href="javascript:void(0);"><i class="icon-plus"></i>Thêm sản phẩm</a>
							</div>
							<div class="right">
								<a href="javascript:void(0);"><i class="icon-pencil"></i>Sửa sản phẩm</a>
								<a href="javascript:void(0);"><i class="icon-remove"></i>Xóa sản phẩm</a>
							</div>
						</div>
						<table class="styled">
							<colgroup>
							...
							?>
								<tr>
									...
									<td><img typeof="foaf:Image" src="<?php echo $upload_path."/product/".product::getInstance()->get_product_feature_image($product->productid);?>" width="125" height="105" alt="" title=""></td>
									<td><?php echo $product->product_title;?></td>
									<td><?php echo product::getInstance()->get_manufacturer_info($product->product_manufaceturer);?></td>
									<td class="center"><?php echo number_format($product->product_price, 0, ',', '.');?></td>
									<td class="center"><?php echo product::getInstance()->get_product_status($product->product_quantily);?></td>
									<td class="center">
										<a href="<?php echo XC_URL;?>/admin/product/<?php echo $product->productid;?>?action=edit" class="button small grey tooltip" data-gravity=s title="Sửa"><i class="icon-pencil"></i></a>
										<a href="<?php echo XC_URL;?>/admin/product/<?php echo $product->productid;?>?action=delete" class="button small grey tooltip" data-gravity=s title="Xóa"><i class="icon-remove"></i></a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
				...
				<div class="footer"><div class="dataTables_paginate paging_full_numbers" id="DataTables_Table_0_paginate"><a tabindex="0" class="first paginate_button paginate_button_disabled" id="DataTables_Table_0_first">First</a><a tabindex="0" class="previous paginate_button paginate_button_disabled" id="DataTables_Table_0_previous">Previous</a><span><?php
                for ( $page = 1; $page <= $sotrang; $page ++ )
                {
                    ...
                    echo '<a href="?page='.$page.'" tabindex="0" class="'.$class.'">'.$page.'</a>';
                }
            ?></span><a tabindex="0" class="next paginate_button" id="DataTables_Table_0_next">Next</a><a tabindex="0" class="last paginate_button" id="DataTables_Table_0_last">Last</a></div></div>
				<!-- End of .box -->
			</div><!-- End of .grid_4 -->
