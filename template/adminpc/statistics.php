...
<body>
	...
	<div role="main" id="main" class="container_12 clearfix">
		...
		<section id="content" class="container_12 clearfix" data-sort="true">
			<h1 class="grid_12">Thống kê hệ thống</h1>
			
			<div class="grid_12 center-elements">
			
				<div class="full-stats">
					<div class="stat simple" data-value="<?php echo sitesystem::getInstance()->visit("month");?>" data-title="Visits" data-format="+0,0"></div>
				</div>
				
				<div class="full-stats">
					<a href="javascript:void(0);" class="stat simple" data-value="<?php echo sitesystem::getInstance()->usercount("*");?>" data-title="Users" data-format="0,0"></a> <!-- clickable! -->
				</div>
				
				<div class="full-stats">
					<div class="stat simple" data-value="<?php echo order::getInstance()->ordercounter("*");?>" data-title="Orders" data-format="0"></div>
				</div>
			...
			<div class="grid_12 center-elements">
				<div class="full-stats">
					<div class="stat hlist" data-list='[{"val":<?php echo order::getInstance()->sumarypaid(3);?>,"format":"0,0 VNĐ;-0,0 VNĐ","title":"giao dịch thành công","color":"green"},{"val":<?php echo order::getInstance()->sumarypaid(4);?>,"format":"0,0 VNĐ;-0,0 VNĐ","title":"giao dịch thất bại","color":"red"},{"val":<?php echo order::getInstance()->sumarypaid("*");?>,"format":"0,0 VNĐ;-0,0 VNĐ","title":"Tổng cộng"}]'></div>
				</div>
			</div><!-- End of .grid_12 -->
			...
			<div class="grid_12 center-elements">
				...
				<div class="full-stats">
					<div class="stat minichart" data-total=-17 data-values="[2,5,8,7,3,6,4,2,1]" data-title=Users data-format="+0,0;-0,0" data-change=-6></div>
				</div>
				<div class="full-stats">
					<div class="stat minichart" data-total=0 data-values="[0,0,0,1,2,1,-2,-2,-1]" data-title=Orders data-change=0></div>
				</div>
			</div><![endif]--><!-- End of .grid_12 -->
			
			
			
			
			<h1 class="grid_12">Thống kê hoạt động</h1>
			
			<div class="grid_12 center-elements">
				
				<div class="full-stats">
					<h2 class="center">Thành viên (Khách/Thành viên)</h2>
					<div class="stat circular" data-valueformat="0,0" data-list='[{"title":"Khách","val":<?php echo sitesystem::getInstance()->visit("total");?>,"percent":71},{"title":"Thành viên","val":<?php echo sitesystem::getInstance()->usercount("*");?>,"percent":21}]'></div>
				</div>
				
				<div class="full-stats equalHeight">
					<h2 class="center">Server Load</h2>
					<div class="stat load" data-value="21"></div>
				</div>
				
				<div class="full-stats">
					<h2 class="center">Doanh thu (USD)</h2>
					<div class="stat load" data-min="0" data-max="5000" data-format="$0,0" data-value="<?php echo order::getInstance()->sumarypaid(3)/21000;?>"></div>
				</div>
				
			</div><!-- End of .grid_12 -->
			<!--<![endif]-->
			<h1 class="grid_12">Biểu đồ truy cập</h1>
			<div class="grid_12">
				
					
					<div class="content" style="height: 250px;">
						<div class=chart id=autoupdated data-points=false data-legend=false data-flot='{"xaxis":{"show":false},"yaxis":{"min":0,"max":100}}'>
						</div>
					</div><!-- End of .content -->
			...
			<script type="text/javascript">
				$$.ready(function(){
					// Code from http://people.iola.dk/olau/flot/examples/realtime.html
					...
					var plot = $("#autoupdated").data('plot'),
						gridIsDrawn = false;
					
					function update() {
						plot.setData([ getRandomData() ]);
						!gridIsDrawn && plot.setupGrid() && (gridIsDrawn = false);
						plot.draw();
