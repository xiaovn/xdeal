...
<body>
	...
	<div style="display: none;" id="dialog_add_client" title="Tạo mới nhà sản xuất">
		<form action="" method="POST" class="full validate" />
			<div class="row">
				...
				<div>
					<input class="required" type="text" name="manuname" id="manuname" />
					<input type="hidden" value="add" name="manuadd" id="manuadd" />
				</div>
			</div>
		</form>
		<div class="actions">
...
﻿			<h1 class="grid_12">Quản lý nhà sản xuất</h1>
				...
				<div class="box">
					...
					<div class="content">
						...
						<div class="tabletools">
							<div class="left">
								<a class="open-add-client-dialog" href="javascript:void(0);"><i class="icon-plus"></i>Thêm nhà sản xuất mới</a>
							</div>
							<div class="right">
						...
						<table class="styled">
							...
							?>
								<tr>
									...
									<td><?php echo  $manu->manuid;?></td>
									<td><?php echo  $manu->manuname;?></td>
									<td class="center">
										<a href="<?php echo XC_URL;?>/admin/manufaceturer/?action=edit&manuid=<?php echo $manu->manuid;?>" class="button small grey tooltip" data-gravity=s title="Sửa"><i class="icon-pencil"></i></a>
										<a href="<?php echo XC_URL;?>/admin/manufaceturer/?action=delete&manuid=<?php echo $manu->manuid;?>" class="button small grey tooltip" data-gravity=s title="Xóa"><i class="icon-remove"></i></a>
									</td>
								</tr>
								<?php }?>
							</tbody>
			...
			<div class="grid_12">
				...
				<fieldset>
					<div class="row">
						<label for="manuds">
							<strong>Mã nhà sản xuất</strong>
						</label>
						<div>
							<input type="text" value="<?php echo $manuid;?>" disabled name="manuids" id="manuids" />
						</div>
					</div>
					<div class="row">
						<label for="manuname">
						...
						<div>
							<input type="text" value="<?php echo $manuname;?>" name="manuname" id="manuname" />
							<input type="hidden" value="update" name="manuupdate" id="manuupdate" />
							<input type="hidden" value="<?php echo $manuid;?>" name="manuid" id="manuid" />
						</div>
					</div>
