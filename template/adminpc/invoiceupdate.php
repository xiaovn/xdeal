...
﻿			<h1 class="grid_12">Quản lý đơn hàng số <?php echo $orderid;?></h1>

			<div class="grid_12">
				<form action="?action=update" method="POST" class="grid_12">
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input type="text" value="<?php echo $invoice->shipping_name;?>" name="shipping_name" id=f1_normal_input />
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<input type="text" placeholder="Ghi rõ địa chỉ" value="<?php echo $invoice->shipping_address;?>" name="shipping_address" id=f1_placeholder />
						</div>
					</div>
					...
					<div class="row not-on-phone">
						...
						<div>
							<textarea class="editor" name="billcomment" id="f1_wysiwyg" ><?php echo $invoice->billcomment;?></textarea>
						</div>
					</div>
				...
				<fieldset class="not-on-phone">
					<legend>Tình trạng đơn hàng</legend>
					...
					<div class="row">
						...
						<div>
							<select name="status" id=f2_select2 data-placeholder="Chọn trạng thái">
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input type="datetime" name="paymentdate" id=f3_datepicker />
						</div>
					</div>
