...
﻿			<h1 class="grid_12">Cấu hình thanh toán</h1>
			
			<form action="" method="post" class="grid_12">
				<fieldset>
					<legend>Thanh toán trực tuyến</legend>
					
					<div class="row">
						<label for="baokim">
							<strong>Email Bảo Kim:</strong>
						</label>
						<div>
							<input type="text" value="<?php echo sitesystem::getInstance()->get_meta("baokim");?>" name="baokim" id="baokim" />
						</div>
					</div>
					<div class="row">
						<label for="nganluong">
						...
						<div>
							<input type="text" value="<?php echo sitesystem::getInstance()->get_meta("nganluong");?>" name="nganluong" id="nganluong" />
						</div>
					</div>
				...
				<fieldset class="not-on-phone">
					<legend>Thanh toán trực tiếp</legend>
					
					<div class="row not-on-phone">
						<label for="paymentadd">
							<strong>Thông tin thanh toán</strong>
							<small>Qua bưu điện</small>
						</label>
						<div>
							<textarea class="editor" name="paymentadd" id="paymentadd" ><?php echo sitesystem::getInstance()->get_meta("paymentadd");?></textarea>
						</div>
					</div>
