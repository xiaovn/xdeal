...
﻿			<h1 class="grid_12">Quản lý tin tức</h1>
				...
				<div class="box">
					...
					<div class="content">
						...
						<div class="tabletools">
							<div class="left">
								<a href="<?php echo XC_URL;?>/admin/addnews"><i class="icon-plus"></i>Thêm tin mới</a>
							</div>
							<div class="right">
						...
						<table class="styled">
							...
							?>
								<tr>
									...
									<td class="center"><?php echo  $news->newsid;?></td>
									<td><?php echo  $news->newstitle;?></td>
									<td class="center"><?php echo  $news->newsauthor;?></td>
									<td class="center"><?php echo  $news->newspostdate;?></td>
									<td class="center">
										<a href="<?php echo XC_URL;?>/admin/news/?action=edit&newsid=<?php echo $news->newsid;?>" class="button small grey tooltip" data-gravity=s title="Sửa"><i class="icon-pencil"></i></a>
										<a href="<?php echo XC_URL;?>/admin/news/?action=delete&newsid=<?php echo $news->newsid;?>" class="button small grey tooltip" data-gravity=s title="Xóa"><i class="icon-remove"></i></a>
									</td>
								</tr>
								<?php }?>
							</tbody>
