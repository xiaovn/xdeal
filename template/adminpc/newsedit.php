...
﻿			<h1 class="grid_12">Chỉnh sửa tin tức</h1>
			
			<form action="" method="post" class="grid_12">
				<fieldset>
					<legend>Nội dung tin</legend>
					<div class="row">
						<label for="newsids">
							<strong>Mã tin tức</strong>
						</label>
						<div>
							<input type="text" value="<?php echo $newsid;?>" disabled name="newsids" id="newsids" />
						</div>
					</div>
					<div class="row">
						<label for="newstitle">
						...
						<div>
							<input type="text" value="<?php echo $news->newstitle;?>" name="newstitle" id="newstitle" />
						</div>
					</div>
					<div class="row">
						<label for="newsauthor">
							<strong>Tác giả</strong>
						</label>
						<div>
							<select name="newsauthor" id="newsauthor" class="search" data-placeholder="<?php echo sitesystem::getInstance()->get_user_info($news->newsauthor,"username");?>">
								<option value=""></option>
                                <?php
                                $listuser = sitesystem::getInstance()->userlist();
					...
					<div class="row not-on-phone">
						...
						<div>
							<textarea class="editor" name="newscontent" id="newscontent" ><?php echo $news->newscontent;?></textarea>
						</div>
					</div>
                    <div class="row not-on-phone">
                        <label for="newsthumb">
                        ...
                        <div>
                            <input type="file" id="newsthumb" name="newsthumb" />
                        </div>
                    </div>
				...
				<fieldset>
						...
						<div class="right">
							...
							<input type="hidden" value="update" name="newsupdate" />
						</div>
					</div>
