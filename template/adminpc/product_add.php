...
﻿			<h1 class="grid_12">Thêm mới sản phẩm</h1>

			<form action="" enctype="multipart/form-data" method="POST" class="grid_12">
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input type="text" value="" name="product_title" id="product_title" />
						</div>
					</div>
					<div class="row">
						...
						<div>
							<select name="product_category" id="product_category" class="search" data-placeholder="Chọn danh mục">
							<?php
					...
					<div class="row not-on-phone">
						...
						<div>
							<textarea class="editor" name="product_description" id="product_description"></textarea>
						</div>
					</div>
					<div class="row">
						<label for="product_manufaceturer">
							<strong>Nhà sản xuất</strong>
						</label>
						<div>
							<select name="product_manufaceturer" id="product_manufaceturer" class="search" data-placeholder="Chọn nhà sản xuất">
							<?php
					...
					<div class="row">
						...
						<div>
							<input data-type="spinner" min=0 max=2000000000 value="" id="product_price" name="product_price" />
						</div>
					</div>
					<div class="row">
						...
						<div>
							<input data-type="spinner" min=0 max=200 value="12" id="product_warranty" name="product_warranty" />
						</div>
					</div>
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input data-type="spinner" min=0 max=200000 value="" id="product_quantily" name="product_quantily" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<div><input type="radio" name="product_onsale" checked=checked id="f4_rb1" value="1"><label for="f4_rb1">Đang bán</label></div>
					...
					<div class="row">
						...
						<div>
							<select name="product_promoid" id="product_promoid" class="search" data-placeholder="Chọn khuyến mãi">
							<?php
				...
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<input type="text" value="" name="fos" id="fos" />
						</div>
					</div>
					<div class="row">
						<label for="flanguage">
						...
						<div>
							<input type="text" value="" name="flanguage" id="flanguage" />
						</div>
					</div>
					<div class="row">
						<label for="fcpu">
						...
						<div>
							<input type="text" value="" name="fcpu" id="fcpu" />
						</div>
					</div>
					<div class="row">
						<label for="fcache">
						...
						<div>
							<input type="text" value="" name="fcache" id="fcache" />
						</div>
					</div>
					<div class="row">
						<label for="fram">
						...
						<div>
							<input type="text" value="" name="fram" id="fram" />
						</div>
					</div>
					<div class="row">
						<label for="fhdd">
						...
						<div>
							<input type="text" value="" name="fhdd" id="fhdd" />
						</div>
					</div>
					<div class="row">
						<label for="fgraphic">
						...
						<div>
							<input type="text" value="" name="fgraphic" id="fgraphic" />
						</div>
					</div>
					<div class="row">
						<label for="fscreen">
						...
						<div>
							<input type="text" value="" name="fscreen" id="fscreen" />
						</div>
					</div>
					<div class="row">
						<label for="fusb">
						...
						<div>
							<input type="text" value="" name="fusb" id="fusb" />
						</div>
					</div>
					<div class="row">
						<label>
						...
						<div>
							<div><input type="checkbox" name="faudio" id="faudio" /> <label for="faudio">Audio</label></div>
							<div><input type="checkbox" name="fhdmi" id="fhdmi" /> <label for="fhdmi">HDMI</label></div>
							<div><input type="checkbox" name="fmemorystick" id="fmemorystick" /> <label for="fmemorystick">Memorystick</label></div>
							<div><input type="checkbox" name="fsdstick" id="fsdstick" /> <label for="fsdstick">SDstick</label></div>
							<div><input type="checkbox" name="fsdstick" id="fsdstick" /> <label for="fsdstick">SDstick</label></div>
						</div>
					</div>
					<div class="row">
						...
						<div>
							<input type="text" value="" name="fcamera" id="fcamera" />
						</div>
					</div>
					<div class="row">
						<label for="fwireless">
						...
						<div>
							<input type="text" value="" name="fwireless" id="fwireless" />
						</div>
					</div>
					<div class="row">
						...
						<div>
							<input type="text" value="" name="fbluetooth" id="fbluetooth" />
						</div>
					</div>
					<div class="row">
						<label for="fbattery">
						...
						<div>
							<input type="text" value="" name="fbattery" id="fbattery" />
						</div>
					</div>
					<div class="row">
						<label>
						...
						<div>
							<div><input type="checkbox" name="fcolor[]" value="red" id="fcolor" /> <label for="faudio">Đỏ</label></div>
							<div><input type="checkbox" name="fcolor[]" value="blue" id="fcolor" /> <label for="faudio">Xanh dương</label></div>
							<div><input type="checkbox" name="fcolor[]" value="green" id="fcolor" /> <label for="faudio">Xanh lá</label></div>
							<div><input type="checkbox" name="fcolor[]" value="black" id="fcolor" /> <label for="faudio">Đen</label></div>
							<div><input type="checkbox" name="fcolor[]" value="white" id="fcolor" /> <label for="faudio">Trắng</label></div>
						</div>
					</div>
					<div class="row">
						<label for="forigin">
						...
						<div>
							<input type="text" value="" name="forigin" id="forigin" />
						</div>
					</div>
				</fieldset><!-- End of fieldset -->
				<fieldset>
