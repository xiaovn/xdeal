...
﻿			<h1 class="grid_12">Thêm tin tức mới</h1>
			...
			<form action="" enctype="multipart/form-data"  method="POST" class="grid_12">
				<fieldset>
					...
					<div class="row">
						...
						<div>
							<select name="newsauthor" id="newsauthor" class="search" data-placeholder="Chọn tác giả">
								<option value=""></option>
                                <?php
					...
					<div class="row not-on-phone">
						...
						<div>
							<textarea class="editor" name="newscontent" id="newscontent" ></textarea>
						</div>
					</div>
                    <div class="row not-on-phone">
                        <label for="newsthumb">
				...
				<fieldset>
						...
						<div class="right">
							...
							<input type="hidden" value="add" name="newsadd" />
						</div>
					</div>
